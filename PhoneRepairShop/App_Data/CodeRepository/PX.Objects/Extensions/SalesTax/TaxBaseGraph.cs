...
namespace PX.Objects.Extensions.SalesTax
{
         ...
         where TPrimary : class, IBqlTable, new()
    {
        ...
        {
            if (IsTaxCalcModeEnabled && (taxToAdjust.TaxCalcType == CSTaxCalcType.Item || CalcGrossOnDocumentLevel) && taxToAdjust.TaxCalcLevel != CSTaxCalcLevel.CalcOnItemAmtPlusTaxAmt)
            {
        ...
        protected virtual TaxTotal CalculateTaxSum(object taxrow, object row)
        {
            ...
            else if (CalcGrossOnDocumentLevel && IsTaxCalcModeEnabled && GetTaxCalcMode() == TaxCalculationMode.Gross)
            {
