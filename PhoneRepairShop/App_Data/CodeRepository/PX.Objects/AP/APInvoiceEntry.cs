	...
	public class APInvoiceEntry : APDataEntryGraph<APInvoiceEntry, APInvoice>, PXImportAttribute.IPXPrepareItems, IGraphWithInitialization
	{
		...
		public virtual void AddTaxes(PendingPPDDebitAdjApp doc)
		{
			...
			foreach (PXResult<APTaxTran, Tax> res in taxes)
			{
				...
				decimal? curyTaxAmtSumm = taxTran.CuryTaxAmtSumm - taxTran.CuryDiscountedPrice;
				...
				taxTranNew.CuryTaxAmtSumm += curyTaxAmtSumm;
				...
				if (tax.TaxCalcLevel == CSTaxCalcLevel.Inclusive && Document.Current.TaxCalcMode != TaxCalculationMode.Net || Document.Current.TaxCalcMode == TaxCalculationMode.Gross)
				{
