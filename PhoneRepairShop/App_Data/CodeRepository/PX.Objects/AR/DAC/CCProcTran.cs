...
namespace PX.Objects.AR
{
	...
	public static class CVVVerificationStatusCode 
	{
		...
		private static (CcvVerificationStatus, string) [] _statuses = new [] {
			(CcvVerificationStatus.Match, Match), (CcvVerificationStatus.NotMatch, NotMatch), (CcvVerificationStatus.NotProcessed, NotVerified),
			(CcvVerificationStatus.ShouldHaveBeenPresent, ShouldHaveBeenPresented), (CcvVerificationStatus.IssuerUnableToProcessRequest, IssuerUnableToVerify),
			(CcvVerificationStatus.RelyOnPreviousVerification, RelyOnPriorVerification), (CcvVerificationStatus.Unknown, Unknown)
		};
