...
namespace PX.Objects.AR
{
	...
	public class PaymentRefAttribute : PXEventSubscriberAttribute, IPXRowPersistingSubscriber, IPXFieldDefaultingSubscriber, IPXFieldVerifyingSubscriber
	{
		...
		public const string PaymentRef_AskKeyUpdateLastRefNbr = "PaymentRef_AskKeyUpdateLastRefNbr";
			...
			if (det != null && det.ARAutoNextNbr == true)
			{
					...
					object.Equals(OldValue, e.NewValue) == false)
				{
					try
					{
						...
						{
							WebDialogResult result = sender.Graph.Views["Document"].Ask(PaymentRef_AskKeyUpdateLastRefNbr, e.Row, Messages.AskConfirmation, Messages.AskUpdateLastRefNbr, MessageButtons.YesNo, MessageIcon.Question);
