...
namespace PX.Objects.PM
{
	...
	public class PMAllocator : PXGraph<PMAllocator>, IRateTable
	{
		...
		public virtual bool ProcessStep(PMTask task, PMAllocationDetail step)
		{
			if (step.Post == true)
			{
		...
		public virtual void Post(PMAllocationDetail step, PMTask task, List<PMTran> sourceList, List<PMTran> allocatedList)
		{
	   ...
	   public virtual void PostAllocatedTrans(PMAllocationDetail step, List<PMTranWithTrace> allocated)
		{
		...
		public List<PMTranWithTrace> ProcessBudgetStep(PMAllocationDetail step, PMTask task)
		{
		...
		public virtual List<PMTranWithTrace> AllocateBudget(PMTask task, PMAllocationDetail step, int origAccountGroupID, int inventoryID, int costCodeID, string UOM, decimal amount, decimal quantity)
		{
