	...
	public class ARInvoiceEntryExt : PXGraphExtension<ARInvoiceEntry>
	{
		...
		public virtual void AddToInvoiced(ARTran line, int? revenueAccountGroup, int mult = 1)
		{
			...
			if (project != null && project.NonProject != true)
			{
				...
				if (project.BudgetLevel == BudgetLevels.Item || project.BudgetLevel == BudgetLevels.Detail)
				{
				...
				PMAccountGroup ag = PXSelect<PMAccountGroup, 
					Where<PMAccountGroup.groupID, Equal<Required<PMAccountGroup.groupID>>>>.Select(Base, revenueAccountGroup);
