namespace PX.Objects.TX
{
	...
	public partial class TaxRev : PX.Data.IBqlTable
	{
		...
		#region TaxableMinQty
		/// <summary>
		/// The minimum taxable quantity for Specific/Per Unit taxes.
		/// </summary>
		public abstract class taxableMinQty : PX.Data.BQL.BqlDecimal.Field<taxableMinQty> { }

		/// <summary>
		/// The minimum taxable quantity for Specific/Per Unit taxes.
		/// </summary>
		[PXDBDecimal(4)]
		[PXUIField(DisplayName = "Min. Taxable Quantity")]
		public virtual decimal? TaxableMinQty
		{
			get;
			set;
		}
		...
		/// </summary>
		[PXDBDecimal(4)]
		[PXUIField(DisplayName = "Max. Taxable Quantity")]
