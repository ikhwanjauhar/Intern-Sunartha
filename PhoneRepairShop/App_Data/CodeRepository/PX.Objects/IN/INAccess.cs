...
namespace PX.Objects.IN
{
	...
	public class INAccess : PX.SM.BaseAccess
	{
		...
		[GL.Account(Visibility = PXUIVisibility.Invisible)]
		protected virtual void INSite_DiscAcctID_CacheAttached(PXCache sender) { }
		[GL.Account(Visibility = PXUIVisibility.Invisible)]
		...
		[GL.Account(Visibility = PXUIVisibility.Invisible)]
		protected virtual void INSite_FreightAcctID_CacheAttached(PXCache sender) { }
		[GL.Account(Visibility = PXUIVisibility.Invisible)]
		protected virtual void INSite_MiscAcctID_CacheAttached(PXCache sender) { }
		[GL.Account(Visibility = PXUIVisibility.Invisible)]
