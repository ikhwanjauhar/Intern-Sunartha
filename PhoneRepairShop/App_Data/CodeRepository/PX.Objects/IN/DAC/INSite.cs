...
namespace PX.Objects.IN
{
	...
	public partial class INSite : PX.Data.IBqlTable, PX.SM.IIncludable
	{
		...
		[Account(DisplayName = "Freight Charge Account", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Account.description), AvoidControlAccounts = true)]
		...
		[Account(DisplayName = "Misc. Charge Account", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Account.description), AvoidControlAccounts = true)]
		...
		#endregion
		#region PickByLocationsPickPriority
		public abstract class pickByLocationsPickPriority : PX.Data.BQL.BqlBool.Field<pickByLocationsPickPriority> { }
		[PXDBBool]
		[PXDefault(true)]
		[PXUIField(DisplayName = "Pick by Location Pick Priority")]
		public virtual bool? PickByLocationsPickPriority
		{
			get;
			set;
		}
