...
namespace PX.Objects.FS
{
    public class SvrOrdTypeMaint : PXGraph<SvrOrdTypeMaint, FSSrvOrdType>
    {
        ...
        public virtual void SetPostingSettingVisibility(PXCache cache, FSSrvOrdType fsSrvOrdTypeRow, bool isVisible)
        {
            ...
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.allowQuickProcess>(cache, fsSrvOrdTypeRow, isVisible && (fsSrvOrdTypeRow.PostTo == ID.SrvOrdType_PostTo.SALES_ORDER_MODULE || fsSrvOrdTypeRow.PostTo == ID.SrvOrdType_PostTo.SALES_ORDER_INVOICE));
