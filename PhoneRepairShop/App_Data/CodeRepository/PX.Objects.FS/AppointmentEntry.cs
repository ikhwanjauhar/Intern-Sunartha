    ...
    public class AppointmentEntry : AppointmentEntryBase<AppointmentEntry>, IGraphWithInitialization
    {
        ...
        public virtual IEnumerable StartAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                FSAppointment fsAppointmentCopy = (FSAppointment)this.Caches[typeof(FSAppointment)].CreateCopy(fsAppointmentRow);

                AppointmentCore.VerifyStatusTransition(this, fsAppointmentRow, ServiceOrderRelated.Current, ID.Status_Appointment.IN_PROCESS);
                ...
                using (var ts = new PXTransactionScope())
                {
                    ...
                    AppointmentCore.UpdateAppointmentDetActualFields(AppointmentDetServices, AppointmentDetParts, AppointmentServiceEmployees);
                    ...
                    AppointmentDateTimeHelper.UpdateStaffActualDuration(this, AppointmentServiceEmployees);
                    ...
                    this.ChangeStatusSave(fsAppointmentCopy);
        ...
        public virtual IEnumerable CancelAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                AppointmentCore.VerifyStatusTransition(this, fsAppointmentCopy, ServiceOrderRelated.Current, ID.Status_Appointment.CANCELED);

                using (var ts = new PXTransactionScope())
                {
                    updateContractPeriod = true;
                    fsAppointmentCopy = (FSAppointment)SharedFunctions.ChangeAppointmentStatus(AppointmentRecords.View, fsAppointmentCopy, ID.Status_Appointment.CANCELED);
        ...
        public virtual IEnumerable ReopenAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                AppointmentCore.VerifyStatusTransition(this, fsAppointmentRow, ServiceOrderRelated.Current, ID.Status_Appointment.MANUAL_SCHEDULED);
                ...
                using (var ts = new PXTransactionScope())
                {
                    fsAppointmentCopy = (FSAppointment)SharedFunctions.ChangeAppointmentStatus(AppointmentRecords.View, fsAppointmentCopy, ID.Status_Appointment.MANUAL_SCHEDULED);
                    AppointmentRecords.Cache.SetDefaultExt<FSAppointment.billContractPeriodID>(fsAppointmentCopy);

                    AppointmentCore.UpdateAppointmentDetActualFields(AppointmentDetServices, AppointmentDetParts, AppointmentServiceEmployees, true);
        ...
        public virtual IEnumerable CompleteAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                AppointmentCore.VerifyStatusTransition(this, AppointmentRecords.Current, ServiceOrderRelated.Current, ID.Status_Appointment.COMPLETED);
                
                AppointmentDateTimeHelper.UpdateAndCheckActualDateTimes(ServiceOrderTypeSelected.Current,
                ...
                using (var ts = new PXTransactionScope())
                {
                    ...
                    AppointmentDateTimeHelper.UpdateStaffActualDateTimeOnCompleteApp(AppointmentServiceEmployees, AppointmentRecords.Current);
                    ...
                    if (IsMobile == true
                            && SetupRecord.Current != null
                                && SetupRecord.Current.TrackAppointmentLocation == true
                                    && string.IsNullOrEmpty(AppointmentRecords.Current.Mem_GPSLatitudeLongitude) == false)
                    {
                        string[] parts = AppointmentRecords.Current.Mem_GPSLatitudeLongitude.Split(':');
                        AppointmentRecords.Current.GPSLatitudeComplete = decimal.Parse(parts[0]);
                        AppointmentRecords.Current.GPSLongitudeComplete = decimal.Parse(parts[1]);
                    }

                    this.CalculateCosts();
                    this.ChangeStatusSave(AppointmentRecords.Current);
        ...
        public virtual IEnumerable CloseAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                AppointmentCore.VerifyStatusTransition(this, fsAppointmentCopy, ServiceOrderRelated.Current, ID.Status_Appointment.CLOSED);

                if (fsAppointmentCopy.TimeRegistered == false && ServiceOrderTypeSelected.Current.RequireTimeApprovalToInvoice == true)
                {
                ...
                {
                    updateContractPeriod = true;
                    fsAppointmentCopy = (FSAppointment)SharedFunctions.ChangeAppointmentStatus(AppointmentRecords.View, fsAppointmentCopy, ID.Status_Appointment.CLOSED);
                    this.ChangeStatusSave(fsAppointmentCopy);
        ...
        public virtual IEnumerable UncloseAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                                                                  ...
                                                                  MessageButtons.YesNo))
                {
                    ...
                    {
                        updateContractPeriod = true;
                        fsAppointmentCopy = (FSAppointment)SharedFunctions.ChangeAppointmentStatus(AppointmentRecords.View, fsAppointmentCopy, ID.Status_Appointment.COMPLETED);
        ...
        public virtual IEnumerable EmailSignedAppointment(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in list)
            {
                ...
                AppointmentCore.SendNotification(AppointmentRecords.Cache, fsAppointmentRow, FSMailProcess.FSMailing.EMAIL_NOTIFICATION_TO_GEOZONE_STAFF, ServiceOrderRelated.Current.BranchID, attachments);
            }
        ...
        public virtual IEnumerable StartService(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in adapter.Get<FSAppointment>())
            {
                if (AppointmentRecords.Cache.GetStatus(fsAppointmentRow) != PXEntryStatus.Inserted)
                {
                    ...
                    if (fsAppointmentDetRow != null && (fsAppointmentDetRow.LineType == ID.LineType_All.SERVICE || fsAppointmentDetRow.LineType == ID.LineType_All.NONSTOCKITEM))
                    {
                        ...
                        {
                            AppointmentDateTimeHelper.UpdateStaffActualTimeFromService(fsAppointmentDetRow, AppointmentServiceEmployees);
                        }
        ...
        public virtual IEnumerable StartTimeStaff(PXAdapter adapter)
        {
            ...
            foreach (FSAppointment fsAppointmentRow in adapter.Get<FSAppointment>())
            {
                if (AppointmentRecords.Cache.GetStatus(fsAppointmentRow) != PXEntryStatus.Inserted)
                {
                    FSAppointmentEmployee fsAppointmentEmployeeRow = AppointmentServiceEmployees.Current;
                    ...
                    if (fsAppointmentEmployeeRow != null)
                    {
                        ...
                        SharedFunctions.SaveUpdatedChanges(AppointmentServiceEmployees.Cache, fsAppointmentEmployeeRow);
                    }
                }
        ...
        public virtual List<ServiceRequirement> GetAppointmentDetServiceRowLicenses(
        ...
        public virtual List<ServiceRequirement> GetAppointmentDetServiceRowSkills(
                                                                        PXResultset<FSAppointmentDetService> bqlResultSet,
        ...
        public virtual void CalculateLaborCosts()
        {
            ...
            foreach (FSAppointmentEmployee fsAppointmentEmployeeRow in this.AppointmentServiceEmployees.Select())
            {
                this.AppointmentServiceEmployees.Cache.RaiseFieldDefaulting<FSAppointmentEmployee.unitCost>(fsAppointmentEmployeeRow, out unitcost);
                fsAppointmentEmployeeRow.CuryUnitCost = (decimal)unitcost;
                this.AppointmentServiceEmployees.Update(fsAppointmentEmployeeRow);
                //this.AppointmentServiceEmployees.Cache.SetStatus(fsAppointmentEmployeeRow, PXEntryStatus.Updated);
            }
        }
        ...
        public virtual decimal? CalculateLaborCost(PXCache cache, FSAppointmentEmployee fsAppointmentEmployeeRow, FSAppointment fsAppointmentRow)
        {
        ...
        public virtual List<FSProfitability> Delegate_ProfitabilityRecords(PXCache cache, FSAppointment fsAppointmentRow)
        {
            ...
            foreach (FSAppointmentEmployee fsAppEmployee in AppointmentServiceEmployees.Select().AsEnumerable().Where(x => ((FSAppointmentEmployee)x).CuryUnitCost != 0m))
            {
        ...
        public virtual void SetTimeRegister(FSAppointment fsAppointmentRow, FSSrvOrdType fsSrvOrdTypeRow, PXDBOperation operation)
        {
                    ...
                    && operation == PXDBOperation.Update)
            {
                ...
                if (result.Count > 0 || AppointmentServiceEmployees.Select().Count == 0)
                {
        ...
        protected virtual void CalculateEndTimeWithLinesDuration(PXCache cache, FSAppointment fsAppointmentRow,
        ...
        public virtual void EnableDisable_MobileActions(PXCache cache, FSAppointment fsAppointmentRow, object row)
        {
        ...
        public virtual void EnableDisable_ActionButtons(PXCache cache, FSAppointment fsAppointmentRow,
        ...
        /// </summary>
        public virtual void EnableDisableAppointmentDetTabs(FSServiceOrder fsServiceOrderRow)
        {
            if (fsServiceOrderRow != null)
            {
        ...
        public virtual bool IsTheLastestActiveAppointmentInServicesOrder(FSServiceOrder fsServiceOrderRow, FSAppointment fsAppointmentRow, bool includeCompleteStatus = false)
        {
        ...
        public virtual void CheckScheduledDateTimes(
                                            PXCache cache, 
        ...
        public virtual void CheckActualDateTimes(
                                        PXCache cache,
                                        FSAppointment fsAppointmentRow)
        {
        ...
        /// </summary>
        public virtual void SetAppointmentLineActualDates(PXCache cache, FSAppointmentDet fsAppointmentDetRow)
        {
        ...
        public virtual void HideOrShowTimeCardsIntegration(PXCache cache, FSAppointment fsAppointmentRow)
        {
                    ...
                    && ServiceOrderTypeSelected.Current != null)
            {
                ...
                PXCache cacheFSAppointmentEmployee = this.AppointmentServiceEmployees.Cache;
        ...
        protected virtual bool UpdateServiceOrder(
                                            FSAppointment fsAppointmentRow,
                                            ...
                                            PXTranStatus? tranStatus)
        {
            ...
            else
            {
                ...
                foreach (FSAppointmentDetService fsAppointmentDetServiceRow in fsAppointmentDetServiceSet)
                {
                    ...
                    AppointmentCore.InsertUpdateAppointmentInfoInServiceOrder<FSSODetService>(AppointmentRecords.Cache,
                                                                                         AppointmentRecords.Current,
                                                                                         AppointmentDetServices.Cache,
                                                                                         fsAppointmentDetServiceRow,
                                                                                         graphServiceOrderEntry.ServiceOrderRecords,
                                                                                         graphServiceOrderEntry.ServiceOrderDetServices);
                }
                ...
                foreach (FSAppointmentDetPart fsAppointmentDetPartRow in fsAppointmentDetPartSet)
                {
                    ...
                    AppointmentCore.InsertUpdateAppointmentInfoInServiceOrder<FSSODetPart>(AppointmentRecords.Cache,
                                                                                      AppointmentRecords.Current,
                                                                                      AppointmentDetParts.Cache,
        ...
        public virtual void UpdateAppointmentDetService_StaffID(string serviceLineRef, string oldServiceLineRef)
        {
            ...
            {
                var empReferencingLineRef = AppointmentServiceEmployees.Select().AsEnumerable()
                ...
                if (fsAppointmentDetRow.Count() == 1)
                {
                    ...
                    AppointmentCore.UpdateStaffRelatedUnboundFields(AppointmentDetServices.Current, AppointmentServiceEmployees, numEmployeeLinkedToService);
                }
            }
            ...
            {
                var empReferencingOldLineRef = AppointmentServiceEmployees.Select().AsEnumerable()
                ...
                if (serviceOldLineRef.Count() == 1)
                {
                    ...
                    AppointmentCore.UpdateStaffRelatedUnboundFields(AppointmentDetServices.Current, AppointmentServiceEmployees, numOldEmployeeLinkedToService);
                }
            }
        }
        ...
        {
            var fsAppointmentEmployeeRows = AppointmentServiceEmployees.Select()
        ...
        public virtual void CheckQtyAndLotSerial(PXCache cache, FSAppointmentDetPart fsAppointmentDetPartRow, object newValue)
        {
            if (newValue == null)
            {
                return;
        ...
        protected virtual void SetUnitCostByLotSerialNbr(PXCache cache, FSAppointmentDetPart fsAppointmentDetPartRow, string oldLotSerialNbr)
        {
            if (fsAppointmentDetPartRow.EnablePO == true)
            {
                return;
            }
            ...
            if (string.IsNullOrEmpty(fsAppointmentDetPartRow.LotSerialNbr) == true)
            {
                unitCostPair = UnitCostHelper.CalculateCuryUnitCost<FSAppointmentDetPart.unitCost,
                                                                FSAppointmentDetPart.inventoryID,
                                                                FSAppointmentDetPart.uOM>(cache, fsAppointmentDetPartRow, true, 0m);

                cache.SetValueExt<FSAppointmentDetPart.unitCost>(fsAppointmentDetPartRow, unitCostPair.unitCost);
                cache.SetValueExt<FSAppointmentDetPart.curyUnitCost>(fsAppointmentDetPartRow, unitCostPair.curyUnitCost);
            }
            else 
            {
                if (fsAppointmentDetPartRow.LotSerialNbr != oldLotSerialNbr
                    && ServiceOrderRelated.Current?.PostedBy != null)
                {
                    var unitCostRow = PXSelectJoin<FSSODetPart,
                              InnerJoin<FSPostDet,
                                On<FSPostDet.postDetID, Equal<FSSODetPart.postID>>,
                              InnerJoin<INTran,
                              ...
                              Where<
                                  FSSODetPart.srvOrdType, Equal<Required<FSSODetPart.srvOrdType>>,
                              And<
                                  FSSODetPart.refNbr, Equal<Required<FSSODetPart.refNbr>>,
                              And<
                                  FSSODetPart.inventoryID, Equal<Required<FSSODetPart.inventoryID>>,
                              And<
                                  INTran.lotSerialNbr, Equal<Required<INTran.lotSerialNbr>>>>>>>
                              .Select(this, fsAppointmentDetPartRow?.SrvOrdType, ServiceOrderRelated.Current?.RefNbr, fsAppointmentDetPartRow?.InventoryID, fsAppointmentDetPartRow?.LotSerialNbr)
                              .FirstOrDefault();

                    if (unitCostRow != null)
                    {
                        PXResult<FSSODetPart, FSPostDet, INTran> result = (PXResult<FSSODetPart, FSPostDet, INTran>)unitCostRow;
                        INTran inTranRow = (INTran)result;

                        unitCostPair = UnitCostHelper.CalculateCuryUnitCost<FSAppointmentDetPart.unitCost,
                                                                            FSAppointmentDetPart.inventoryID,
                                                                            FSAppointmentDetPart.uOM>(cache, fsAppointmentDetPartRow, false, inTranRow.UnitCost);
        ...
        protected override void FSAppointment_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            AppointmentDateTimeHelper.SetVisible_KeepStaffActualDateTimesCheckBox(ServiceOrderTypeSelected.Current, AppointmentServiceEmployees.Cache);
        ...
        protected virtual void FSAppointment_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            ...
            {
                SharedFunctions.ValidateDuplicateLineNbr(
                                null,
                                null,
                                AppointmentDetServices,
                                AppointmentDetParts,
        ...
        protected virtual void FSAppointmentEmployee_ServiceLineRef_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            if (e.ExternalCall == true)
            {
                ...
                AppointmentDateTimeHelper.UpdateStaffActualDateTimeBegin(ServiceOrderTypeSelected.Current, AppointmentRecords.Current, AppointmentDetServices, AppointmentServiceEmployees);
            }
        }
        ...
        protected virtual void FSAppointmentEmployee_CostCodeID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            {
                e.NewValue = ServiceOrderTypeSelected.Current.DfltCostCodeID;
            }
        }
        ...
        protected virtual void FSAppointmentDetService_SiteID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (ServiceOrderAppointmentHandlers.IsInventoryLine(fsAppointmentDetServiceRow.LineType) == false 
                || fsAppointmentDetServiceRow.InventoryID == null)
            {
                e.NewValue = null;
                e.Cancel = true;
            }
        ...
        protected virtual void FSAppointmentDetService_InventoryID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            if (fsAppointmentDetServiceRow.ContractRelated == true)
            {
                ...
                cache.SetValueExt<FSAppointmentDetService.projectTaskID>(fsAppointmentDetServiceRow, fsContractPeriodDetRow.ProjectTaskID);
                cache.SetValueExt<FSAppointmentDetService.costCodeID>(fsAppointmentDetServiceRow, fsContractPeriodDetRow.CostCodeID);
            }
        ...
        protected virtual void FSAppointmentDetService_BillableQty_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if ((decimal?)e.OldValue != ((FSAppointmentDetService)e.Row).BillableQty)
            {
        ...
        protected virtual void FSAppointmentDetService_ActualDuration_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            if (e.ExternalCall == true)
            {
                ...
                {
                    AppointmentDateTimeHelper.UpdateStaffActualTimeFromService(fsAppointmentDetServiceRow, AppointmentServiceEmployees);
                }
            }
        }
        ...
        protected virtual void FSAppointmentDetService_StaffActualDuration_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    FSAppointmentEmployee fsAppointmentEmployeeRow = AppointmentServiceEmployees.Select().RowCast<FSAppointmentEmployee>()
        ...
        protected virtual void FSAppointmentDetService_StaffID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            if (e.ExternalCall == true)
            {
                AppointmentCore.InsertUpdateDelete_AppointmentDetService_StaffID(cache, fsAppointmentDetServiceRow, AppointmentServiceEmployees, (int?)e.OldValue);
            }
        }
        ...
        protected override void FSAppointmentDetService_RowSelecting(PXCache cache, PXRowSelectingEventArgs e)
        {
            ...
            FSAppointmentDetService fsAppointmentDetServiceRow = (FSAppointmentDetService)e.Row;
            AppointmentCore.UpdateStaffRelatedUnboundFields(fsAppointmentDetServiceRow, AppointmentServiceEmployees);
        }
        ...
        protected virtual void FSAppointmentDetService_RowDeleting(PXCache cache, PXRowDeletingEventArgs e)
        {
            ...
            if (fsSODetRow != null)
            {
                foreach (FSAppointmentEmployee fsAppointmentEmployeeRow in AppointmentServiceEmployees.Select().AsEnumerable().Where(y => ((FSAppointmentEmployee)y).ServiceLineRef == fsSODetRow.LineRef))
                {
                    AppointmentServiceEmployees.Delete(fsAppointmentEmployeeRow);
                }
            }
        ...
        protected virtual void FSAppointmentDetService_CostCodeID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            ServiceOrderCore.SetCostCodeDefault(fsAppointmentDetServiceRow, ServiceOrderRelated.Current?.ProjectID, ServiceOrderTypeSelected.Current, e);
        }

        protected virtual void FSAppointmentDetService_CuryBillableExtPrice_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            AppointmentCore.FSAppointmentDet_CuryBillable_FieldUpdating(cache, AppointmentRecords.Cache, (FSAppointmentDet)e.Row, AppointmentRecords.Current, e);
        }

        protected virtual void FSAppointmentDetService_ContractRelated_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if ((bool?)e.OldValue != ((FSAppointmentDetService)e.Row).ContractRelated)
            {
                cache.SetDefaultExt<FSAppointmentDetService.curyUnitPrice>(e.Row);
            }
        }
        #endregion
        ...
        protected virtual void FSAppointmentDetPart_BillableQty_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if ((decimal?)e.OldValue != ((FSAppointmentDetPart)e.Row).BillableQty)
            {
        ...
        protected virtual void FSAppointmentDetPart_SiteID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (ServiceOrderAppointmentHandlers.IsInventoryLine(fsAppointmentDetPartRow.LineType) == false
                || fsAppointmentDetPartRow.InventoryID == null)
            {
                e.NewValue = null;
                e.Cancel = true;
            }
        ...
        protected virtual void FSAppointmentDetPart_LotSerialNbr_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            ...
            SetUnitCostByLotSerialNbr(cache, fsAppointmentDetPartRow, (string)e.OldValue);
        }
        ...
        protected virtual void FSAppointmentDetPart_CostCodeID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            ServiceOrderCore.SetCostCodeDefault(fsAppointmentDetPartRow, ServiceOrderRelated.Current?.ProjectID, ServiceOrderTypeSelected.Current, e);
        }

        protected virtual void FSAppointmentDetPart_CuryBillableExtPrice_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSAppointmentDetPart_ContractRelated_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if ((bool?)e.OldValue != ((FSAppointmentDetPart)e.Row).ContractRelated)
            {
                cache.SetDefaultExt<FSAppointmentDetPart.curyUnitPrice>(e.Row);
            }
        }
        #endregion
        ...
        protected virtual void FSAppointmentInventoryItem_BillableQty_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if ((decimal?)e.OldValue != ((FSAppointmentInventoryItem)e.Row).BillableQty)
            {
        ...
        protected virtual void FSAppointmentInventoryItem_CostCodeID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            ServiceOrderCore.SetCostCodeDefault(fsAppointmentInventoryItemRow, ServiceOrderRelated.Current?.ProjectID, ServiceOrderTypeSelected.Current, e);
        }

        protected virtual void FSAppointmentInventoryItem_CuryBillableExtPrice_FieldUpdating(PXCache cache, PXFieldUpdatingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual IEnumerable staffRecords()
        {
            return StaffSelectionHelper.StaffRecordsDelegate(
                                                                (object)AppointmentServiceEmployees,
                                                                SkillGridFilter,
        ...
        public class SalesTax : TaxGraph<AppointmentEntry, FSAppointment>
        {
            ...
            protected override DetailMapping GetDetailMapping()
            {
                return new DetailMapping(typeof(FSAppointmentDetUNION))
                {
                    ...
                    CuryTranDiscount = typeof(FSAppointmentDetUNION.curyDiscAmt),
                    CuryTranExtPrice = typeof(FSAppointmentDetUNION.curyBillableExtPrice)
                };
            }
                    ...
                    case PXTaxCheck.Line:
                        foreach (FSAppointmentTax record in PXSelect<FSAppointmentTax,
                            Where<FSAppointmentTax.entityID, Equal<Current<FSAppointment.appointmentID>>,
                                And<FSAppointmentTax.lineNbr, Equal<Current<FSAppointmentDetUNION.lineNbr>>>>>
