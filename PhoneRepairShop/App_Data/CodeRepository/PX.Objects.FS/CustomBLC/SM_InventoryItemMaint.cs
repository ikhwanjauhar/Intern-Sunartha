...
namespace PX.Objects.FS
{
    public class SM_InventoryItemMaint : PXGraphExtension<InventoryItemMaint>
    {
        ...
        protected virtual void InventoryItem_BillingRule_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSModelComponent_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
