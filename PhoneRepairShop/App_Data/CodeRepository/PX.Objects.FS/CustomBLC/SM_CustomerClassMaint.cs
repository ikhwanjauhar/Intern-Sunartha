...
namespace PX.Objects.FS
{
    public class SM_CustomerClassMaint : PXGraphExtension<CustomerClassMaint>
    {
        ...
        protected virtual void CustomerClass_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSCustomerClassBillingSetup_BillingCycleID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSCustomerClassBillingSetup_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
