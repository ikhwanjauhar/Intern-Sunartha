...
namespace PX.Objects.FS
{
    ...
    public class FSSODetUNION : FSSODet
    {
        ...
        [PXDBCurrency(typeof(FSSODetUNION.curyInfoID), typeof(FSSODetUNION.billableExtPrice))]
        [PXUIField(DisplayName = "Ext. Price")]
        [PXFormula(typeof(Mult<FSSODetUNION.billableExtPrice, FSSODetUNION.curyUnitPrice>))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXDBCurrency(typeof(CommonSetup.decPlPrcCst), typeof(FSSODetUNION.curyInfoID), typeof(FSSODetUNION.discAmt))]
        [PXFormula(typeof(Div<Mult<FSSODetUNION.curyUnitPrice, FSSODetUNION.discPct>, decimal100>))]
