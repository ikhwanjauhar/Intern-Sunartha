...
namespace PX.Objects.FS
{
    ...
    public class FSSODetPart : FSSODet
    {
        ...
        [PXDBCurrency(typeof(FSSODetPart.curyInfoID), typeof(FSSODetPart.billableExtPrice))]
        ...
        [ManualDiscountMode(typeof(FSSODetPart.curyDiscAmt), typeof(FSSODetPart.discPct), DiscountFeatureType.CustomerDiscount)]
        [PXDBBool]
        [PXDefault(false)]
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXDBCurrency(typeof(CommonSetup.decPlPrcCst), typeof(FSSODetPart.curyInfoID), typeof(FSSODetPart.discAmt))]
        [PXFormula(typeof(Div<Mult<FSSODetPart.curyBillableExtPrice, FSSODetPart.discPct>, decimal100>))]
