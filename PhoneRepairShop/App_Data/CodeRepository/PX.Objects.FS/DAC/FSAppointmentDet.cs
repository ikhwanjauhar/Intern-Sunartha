...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDet : IBqlTable, IFSSODetBase, IDocLine, ISortOrder
	{
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXDBCurrency(typeof(CommonSetup.decPlPrcCst), typeof(FSAppointmentDet.curyInfoID), typeof(FSAppointmentDet.discAmt))]
        [PXFormula(typeof(Div<Mult<FSAppointmentDet.curyUnitPrice, FSAppointmentDet.discPct>, decimal100>))]
        ...
        [PXDefault(typeof(Switch<
                                Case<Where<
                                    ...
                                    Or<lineType, Equal<lineType.Comment_Service>,
