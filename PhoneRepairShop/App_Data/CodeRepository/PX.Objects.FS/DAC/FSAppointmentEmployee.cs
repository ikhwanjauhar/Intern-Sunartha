...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentEmployee : PX.Data.IBqlTable
    {
        ...
        [PXParent(typeof(Select<FSAppointmentDetService,
                            Where<
                                FSAppointmentDetService.lineRef, Equal<Current<FSAppointmentEmployee.serviceLineRef>>,
                                And<FSAppointmentDetService.appointmentID, Equal<Current<FSAppointmentEmployee.appointmentID>>>>>))]
