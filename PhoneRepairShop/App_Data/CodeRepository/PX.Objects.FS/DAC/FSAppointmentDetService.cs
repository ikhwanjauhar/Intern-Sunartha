...
namespace PX.Objects.FS
{
    ...
    [PXProjection(typeof(Select<FSAppointmentDet,
                        Where<
                            FSAppointmentDet.lineType, Equal<ListField_LineType_ALL.Service>,
                            Or<FSAppointmentDet.lineType, Equal<ListField_LineType_ALL.Comment_Service>,
                            Or<FSAppointmentDet.lineType, Equal<ListField_LineType_ALL.Instruction_Service>,
                            Or<FSAppointmentDet.lineType, Equal<ListField_LineType_ALL.NonStockItem>>>>>>), Persistent = true)]
    ...
    public class FSAppointmentDetService : FSAppointmentDet
    {
        ...
        [PXParent(typeof(Select<FSAppointment,
                            Where<FSAppointment.srvOrdType, Equal<Current<FSAppointmentDetService.srvOrdType>>,
                                And<FSAppointment.refNbr, Equal<Current<FSAppointmentDetService.refNbr>>>>>))]
        ...
        [LocationAvail(typeof(FSAppointmentDetService.inventoryID), typeof(FSAppointmentDetService.subItemID), typeof(FSAppointmentDetService.siteID), true, false, false)]
        ...
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        [FSINLotSerialNbr(typeof(FSAppointmentDetService.inventoryID), typeof(FSAppointmentDetService.subItemID), typeof(FSAppointmentDetService.siteLocationID))]
        ...
        [PXDefault(typeof(Switch<
                                Case<Where<
                                        lineType, Equal<FSAppointmentDetService.lineType.Service>,
                                        And<status, NotEqual<FSAppointmentDetService.status.Canceled>,
                                        And<
                                            Where<
        ...
        [PXDefault(typeof(Switch<
                                Case<Where<
                                        status, NotEqual<FSAppointmentDetService.status.Canceled>,
                                        And<
                                            Where<
                                                Current<FSAppointment.status>, Equal<FSAppointment.status.InProcess>,
                                                Or<Current<FSAppointment.status>, Equal<FSAppointment.status.Completed>>>>>,
        ...
        [PXDefault(typeof(Switch<
                                Case<Where<
                                    lineType, Equal<lineType.Comment_Service>,
                                    Or<lineType, Equal<lineType.Instruction_Service>>>,
                                    Null>,
        ...
        [PXFormula(typeof(Switch<
                                ...
                                Case<
                                    Where<
                                        FSAppointmentDetService.status, Equal<FSAppointmentDetService.status.Canceled>>,
                                    SharedClasses.decimal_0,
                                Case<
                                    Where2<
                                        Where<
        ...
        // Remove this field in a major update.
        public int? _CostCodeID;
