...
namespace PX.Objects.FS
{
    ...
    public class FSSODetService : FSSODet
    {
        ...
        [SOLocationAvail(typeof(FSSODetService.inventoryID), typeof(FSSODetService.subItemID), typeof(FSSODetService.siteID), typeof(FSSODetService.tranType), typeof(FSSODetService.invtMult))]
        ...
        [PXDBString]
        [PXUIField(DisplayName = "PO Nbr.", Enabled = false, FieldClass = "DISTINV", Visible = false)]
        [PO.PO.RefNbr(typeof(
        ...
        [PXDBCurrency(typeof(FSSODetService.curyInfoID), typeof(FSSODetService.billableExtPrice))]
        ...
        public override Decimal? CuryBillableExtPrice
        {
            get
            {
        ...
        [PXDBBool]
        [ManualDiscountMode(typeof(FSSODetService.curyDiscAmt), typeof(FSSODetService.discPct), DiscountFeatureType.CustomerDiscount)]
        [PXDefault(false)]
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXDBCurrency(typeof(CommonSetup.decPlPrcCst), typeof(FSSODetService.curyInfoID), typeof(FSSODetService.discAmt))]
        [PXFormula(typeof(Div<Mult<FSSODetService.curyBillableExtPrice, FSSODetService.discPct>, decimal100>))]
        ...
        public override Decimal? CuryBillableTranAmt
        {
            get
            {
        ...
        [PXUnboundFormula(typeof(Switch<
                                        Case<
                                             Where<lineType, Equal<lineType.Service>>,
                                             apptDuration>,
                                        SharedClasses.int_0>),
