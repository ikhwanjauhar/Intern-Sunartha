...
namespace PX.Objects.FS
{
    public class AppointmentDateTimeHelper
    {
        ...
        public static void UpdateActualDateTimeBegin(
                                                     ...
                                                     AppointmentCore.AppointmentServiceEmployees_View appointmentEmployeeView,
        ...
        public static void UpdateStaffActualDuration(PXGraph graph, AppointmentCore.AppointmentServiceEmployees_View appointmentEmployeeView)
        {
            foreach (FSAppointmentEmployee fsAppointmentEmployeeRow in appointmentEmployeeView.Select().Where(y => ((FSAppointmentEmployee)y).ServiceLineRef != null))
            {
        ...
        public static void UpdateStaffActualDateTimeOnCompleteApp(AppointmentCore.AppointmentServiceEmployees_View AppointmentEmployees, FSAppointment fsAppointmentRow)
        {
        ...
        public static void UpdateAndCheckActualDateTimes(FSSrvOrdType fsSrvOrdTypeRow,
                                                         FSAppointment fsAppointmentRow,
                                                         AppointmentCore.AppointmentDetServices_View appointmentDetServicesView,
                                                         AppointmentCore.AppointmentServiceEmployees_View appointmentEmployeeView,
                                                         Action onAction,
                                                         Level onLevel)
        {
            UpdateActualDateTimeEnd(fsSrvOrdTypeRow, fsAppointmentRow, appointmentDetServicesView, appointmentEmployeeView, onAction, onLevel);

            string errorMessage = string.Empty;

            if (CheckServiceActualDateTimeBegin(fsAppointmentRow, appointmentDetServicesView, appointmentEmployeeView, ref errorMessage) == false)
            {
                throw new PXException(errorMessage);
            }

            if (CheckServiceActualDateTimes(fsSrvOrdTypeRow, appointmentDetServicesView, appointmentEmployeeView, ref errorMessage) == false)
            {
                throw new PXException(errorMessage);
            }
        }
        ...
        {
            bool visible = isVisibleKeepActualDateTimes(fsSrvOrdTypeRow);
            PXUIFieldAttribute.SetVisible<FSAppointmentServiceEmployee.keepActualDateTimes>(appointmentEmployeeCache, null, visible);
        }
        ...
        public static void UpdateStaffActualTimeFromService(FSAppointmentDet fsAppointmentDetServiceRow, AppointmentCore.AppointmentServiceEmployees_View appointmentEmployeeView)
        {
