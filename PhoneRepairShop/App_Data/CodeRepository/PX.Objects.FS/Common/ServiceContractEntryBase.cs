...
namespace PX.Objects.FS
{
        ...
        where Where : class, IBqlWhere, new()
    {
        ...
        protected virtual void FSServiceContract_ProjectID_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSServiceContract_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            PXUIFieldAttribute.SetEnabled<FSServiceContract.projectID>(
                                                                    cache,
                                                                    fsServiceContractRow,
        ...
        protected virtual void FSContractPeriodDet_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            SharedFunctions.SetEnableCostCodeProjectTask<FSContractPeriodDet.projectTaskID, FSContractPeriodDet.costCodeID>(cache, fsContractPeriodDetRow, fsContractPeriodDetRow.LineType, ServiceContractRecords.Current?.ProjectID);
        }
