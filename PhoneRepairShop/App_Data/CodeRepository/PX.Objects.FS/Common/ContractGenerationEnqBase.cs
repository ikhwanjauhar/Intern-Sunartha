...
namespace PX.Objects.FS
{
        ...
        where TRecordType : IConstant<string>, IBqlOperand, new()
    {
        ...
        protected void createServiceOrder(TimeSlot timeSlotServiceOrder, bool createAppointmentFlag = false, bool appointmentsBelongToRoute = false)
        {
            ...
            graphServiceOrderEntry.ServiceOrderRecords.Cache.SetValueExt<FSServiceOrder.projectID>(fsServiceOrderRow, fsServiceContractRow.ProjectID);
            graphServiceOrderEntry.ServiceOrderRecords.Cache.SetValueExt<FSServiceOrder.dfltProjectTaskID>(fsServiceOrderRow, fsServiceContractRow.DfltProjectTaskID);
                ...
                if (fsScheduleDetServiceRow.LineType == ID.LineType_ServiceContract.SERVICE_TEMPLATE)
                {
                    foreach (FSScheduleDet fsScheduleDetRow in fsScheduleDetTemplateSet.Where(x => ((FSScheduleDet)x).ServiceTemplateID == fsScheduleDetServiceRow.ServiceTemplateID))
                    {
                        ...
                        foreach (FSServiceTemplateDet fsServiceTemplateDetRow_Service in fsServiceTemplateDetSet_Service)
                        {
                            ...
                            if(fsSODetServiceRow.InventoryID != null)
                            { 
                                fsSODetServiceRow.ProjectTaskID = fsScheduleDetServiceRow.ProjectTaskID;
                                fsSODetServiceRow.CostCodeID = fsScheduleDetServiceRow.CostCodeID;
                            }
                        ...
                        foreach (FSServiceTemplateDet fsServiceTemplateDetRow_Part in fsServiceTemplateDetSet_Part)
                        {
                            ...
                            {
                                fsSODetPartRow.ProjectTaskID = fsScheduleDetServiceRow.ProjectTaskID;
                                fsSODetPartRow.CostCodeID = fsScheduleDetServiceRow.CostCodeID;
                            }
            ...
            foreach (FSScheduleDetPart fsScheduleDetPartRow in fsScheduleDetPartSet)
            {
                ...
                fsSODetPartRow.ProjectTaskID = fsScheduleDetPartRow.ProjectTaskID;
                fsSODetPartRow.CostCodeID = fsScheduleDetPartRow.CostCodeID;
        ...
        public PXSelectJoin<FSScheduleDetService,
                                ...
                                Where<
                                    FSSchedule.scheduleID, Equal<Required<FSSchedule.scheduleID>>>,
                                OrderBy<
                                    Asc<FSScheduleDetService.sortOrder>>> ScheduleServicesSelected;
        ...
        public PXSelectJoin<FSScheduleDetPart,
                                ...
                                Where<
                                    FSSchedule.scheduleID, Equal<Required<FSSchedule.scheduleID>>>,
                                OrderBy<
                                    Asc<FSScheduleDetPart.sortOrder>>> SchedulePartsSelected;
        ...
        public PXSelectJoin<FSScheduleDetService,
                                ...
                                And<
                                    Where<
                                        FSScheduleDetService.lineType, Equal<ListField_LineType_Service_ServiceContract.Service_Template>>>>,
                                OrderBy<
                                    Asc<FSScheduleDetService.sortOrder>>> ScheduleTemplatesSelected;
