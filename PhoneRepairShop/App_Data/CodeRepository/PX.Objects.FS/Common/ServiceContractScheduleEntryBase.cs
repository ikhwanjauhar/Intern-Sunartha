...
namespace PX.Objects.FS
{
        ...
        where EntityField : PX.Data.IBqlField
    {
        ...
        public PXSelect<FSSrvOrdType,
                    Where<
                    Where<FSSrvOrdType.srvOrdType, Equal<Required<FSSrvOrdType.srvOrdType>>>>> SrvOrdTypeSelected;
        ...
        public class ScheduleDetServicesOrdered : PXOrderedSelect<TPrimary, FSScheduleDetService,
                            Where<
                                FSScheduleDetService.scheduleID, Equal<Current<Field>>>, OrderBy<Asc<FSScheduleDetService.sortOrder, Asc<FSScheduleDetService.lineNbr>>>>
        {
            public ScheduleDetServicesOrdered(PXGraph graph) : base(graph) { }
            public ScheduleDetServicesOrdered(PXGraph graph, Delegate handler) : base(graph, handler) { }
        ...
        public ScheduleDetServicesOrdered ScheduleDetServices;
        #endregion
        ...
        [PXDynamicButton(new string[] { PartPasteLineCommand, PartResetOrderCommand },
                     new string[] { PX.Data.ActionsMessages.PasteLine, PX.Data.ActionsMessages.ResetOrder },
                     TranslationKeyType = typeof(PX.Objects.Common.Messages))]
        public class ScheduleDetPartsOrdered : PXOrderedSelect<TPrimary, FSScheduleDetPart,
                            Where<
                                FSScheduleDetPart.scheduleID, Equal<Current<Field>>>, OrderBy<Asc<FSScheduleDetPart.sortOrder, Asc<FSScheduleDetPart.lineNbr>>>>
        {
            public ScheduleDetPartsOrdered(PXGraph graph) : base(graph) { }
            public ScheduleDetPartsOrdered(PXGraph graph, Delegate handler) : base(graph, handler) { }
        ...
        [PXImport(typeof(FSSchedule))]
        public ScheduleDetPartsOrdered ScheduleDetParts;
        #endregion
        ...
        protected virtual void FSSchedule_SrvOrdType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSScheduleDetService_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            if (fsScheduleDetServiceRow != null && fsContractScheduleRow != null)
            {
                SharedFunctions.SetEnableCostCodeProjectTask<FSScheduleDetService.projectTaskID, FSScheduleDetService.costCodeID>(cache, fsScheduleDetServiceRow, fsScheduleDetServiceRow.LineType, fsContractScheduleRow.ProjectID);
            }
        }
        ...
        protected virtual void FSScheduleDetService_CostCodeID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSScheduleDetService fsScheduleDetServiceRow = (FSScheduleDetService)e.Row;
            ServiceOrderCore.SetCostCodeDefault(fsScheduleDetServiceRow, CurrentServiceContract.Current?.ProjectID, SrvOrdTypeSelected.Current, e);
        }
        #endregion
        ...
        protected virtual void FSScheduleDetPart_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            ...
            if (fsScheduleDetPartRow != null && fsContractScheduleRow != null)
            {
                SharedFunctions.SetEnableCostCodeProjectTask<FSScheduleDetPart.projectTaskID, FSScheduleDetPart.costCodeID>(cache, fsScheduleDetPartRow, fsScheduleDetPartRow.LineType, fsContractScheduleRow.ProjectID);
            }
        }
        ...
        protected virtual void FSScheduleDetPart_CostCodeID_FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
            ...
            FSScheduleDetPart fsScheduleDetPartRow = (FSScheduleDetPart)e.Row;
            ServiceOrderCore.SetCostCodeDefault(fsScheduleDetPartRow, CurrentServiceContract.Current?.ProjectID, SrvOrdTypeSelected.Current, e);
        }
        #endregion
