...
namespace PX.Objects.FS
{
    public static class ServiceOrderAppointmentHandlers
    {
                ...
                where DAC : class, IBqlTable, IFSSODetBase, new()
        {
            ...
            SetEnabledAndPersistingCheck<FSSODet.discPct>(cache, eRow, eventType,
                                            isEnabled, persistingCheck: null);

            SetEnabledAndPersistingCheck<FSSODet.curyBillableExtPrice>(cache, eRow, eventType,
                                            isEnabled, persistingCheck: null);

            SetEnabledAndPersistingCheck<FSSODet.curyDiscAmt>(cache, eRow, eventType,
                                            isEnabled, persistingCheck: null);
            ...
            SetEnabledAndPersistingCheck<FSSODet.taxCategoryID>(cache, eRow, eventType,
                                            isEnabled, persistingCheck: null);
