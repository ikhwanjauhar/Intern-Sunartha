...
namespace PX.Objects.FS
{
    public class BranchLocationMaint : PXGraph<BranchLocationMaint, FSBranchLocation>
    {
        ...
        #region FSBranchLocation Event Handlers
        protected virtual void FSBranchLocation_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSBranchLocation_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
