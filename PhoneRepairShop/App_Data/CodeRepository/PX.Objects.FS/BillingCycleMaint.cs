...
namespace PX.Objects.FS
{
    public class BillingCycleMaint : PXGraph<BillingCycleMaint, FSBillingCycle>
    {
        ...
        protected virtual void FSBillingCycle_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSBillingCycle_BillingCycleType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSBillingCycle_TimeCycleType_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSBillingCycle_RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSBillingCycle_RowPersisted(PXCache cache, PXRowPersistedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void FSBillingCycle_RowUpdated(PXCache cache, PXRowUpdatedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
