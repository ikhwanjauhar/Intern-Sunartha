...
namespace PX.Objects.FS
{
    public class UpdateInventoryPost : PXGraph<UpdateInventoryPost>
    {
        ...
        /// </summary>
        public virtual void CreateDocuments(List<FSAppointmentInventoryItem> fsAppointmentInventoryItemRows, UpdateInventoryFilter filter)
        {
        ...
        public virtual void CreateDocumentByGroup(List<FSAppointmentInventoryItem> fsAppointmentInventoryItemRows, List<SharedClasses.AppointmentInventoryItemGroup> listGroupToInvoice, UpdateInventoryFilter filter)
        {
        ...
        /// </summary>
        public virtual int CreateDocumentsInIN(FSPostBatch fsPostBatchRow, List<FSAppointmentInventoryItem> fsAppointmentInventoryItemRows, List<SharedClasses.AppointmentInventoryItemGroup> listGroupToUpdateInInventory, UpdateInventoryFilter filter)
        {
        ...
        /// </summary>
        protected virtual void CreateDocumentIssue(INIssueEntry graphINIssueEntry, SharedClasses.AppointmentInventoryItemInfo appointmentInventoryItemInfoRow, FSAppointmentInventoryItem fsAppointmentInventoryItemRow, DateTime? documentDate, string documentPeriod, FSPostBatch fsPostBatchRow, ref string inRefNbr, ref string inDocType)
        {
            if (appointmentInventoryItemInfoRow != null)
            {
                INRegister inRegisterRow;
