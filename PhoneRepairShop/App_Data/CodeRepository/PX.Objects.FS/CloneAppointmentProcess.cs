...
namespace PX.Objects.FS
{
    public class CloneAppointmentProcess : PXGraph<CloneAppointmentProcess>
    {
        ...
        public virtual void CloneServices(AppointmentEntry sourceAppointmentGraph, AppointmentEntry newAppointmentGraph, FSAppointment newAppointmentRow)
        {
            foreach (FSAppointmentDetService sourceRow in sourceAppointmentGraph.AppointmentDetServices.Select())
            {
                ...
                newRow.Qty = 0;
                newRow.PostID = null;
                newRow.CuryTranAmt = 0;
                newRow.CuryBillableTranAmt = 0;
                newRow.CuryBillableExtPrice = 0;
        ...
        public virtual void CloneParts(AppointmentEntry sourceAppointmentGraph, AppointmentEntry newAppointmentGraph, FSAppointment newAppointmentRow)
        {
            foreach (FSAppointmentDetPart sourceRow in sourceAppointmentGraph.AppointmentDetParts.Select())
            {
                ...
                FSAppointmentDet sumFSAppointmentDetPartBillable = 
                    PXSelectJoinGroupBy<FSAppointmentDetPart,
                    ...
                    Where<FSAppointmentDetPart.sODetID, Equal<Required<FSAppointmentDetPart.sODetID>>,
                    ...
                    Aggregate<GroupBy<FSAppointmentDetPart.sODetID, Sum<FSAppointmentDetPart.billableQty>>>>
                ...
                else
                {
                    if (openQty > 0)
                    {
                        ...
                        secondNewRow.Qty = 0;
                        secondNewRow.CuryTranAmt = 0;
                        secondNewRow.CuryBillableTranAmt = 0;
                        secondNewRow.CuryBillableExtPrice = 0;
        ...
        protected virtual void FSCloneAppointmentFilter_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
        {
            if (e.Row == null)
            {
                return;
