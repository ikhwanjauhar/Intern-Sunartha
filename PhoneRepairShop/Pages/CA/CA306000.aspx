...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
                ...
                <Levels>
                    <px:PXGridLevel DataKeyNames="CashAccountID,TranID" DataMember="Details">
                        ...
                        <Columns>
                            ...
                            <px:PXGridColumn DataField="CardNumber" Width="140" />
                            ...
                            <Levels>
                              <px:PXGridLevel DataMember="ExpenseReceiptDetailMatches">
                                ...
                                <Columns>
                                  ...
                                  <px:PXGridColumn TextAlign="Right" DataField="MatchRelevance" Width="80px" />
    ...
    <px:PXSmartPanel ID="pnlMatchSettings" runat="server" Style="z-index: 108;" Key="matchSettings"
        ...
        <px:PXPanel ID="PXPanel2" runat="server" SkinID="Buttons">
            <px:PXButton ID="pbClose" runat="server" DialogResult="OK" Text="Save & Close" TabIndex="100" />
        </px:PXPanel>
    </px:PXSmartPanel>
