                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CaseRefs">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="RelationType" RenderEditorText="True" />
                                    <px:PXGridColumn DataField="CRCase__Subject" />
                                    <px:PXGridColumn DataField="CRCase__Status" />
                                    <px:PXGridColumn DataField="CRCase__OwnerID" />
                                    <px:PXGridColumn DataField="CRCase__WorkgroupID" />
                                </Columns>
