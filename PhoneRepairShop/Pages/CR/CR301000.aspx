...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CR.LeadMaint"
		PrimaryView="Lead">
		...
		<Items>
			<px:PXTabItem Text="Details" RepaintOnDemand="False">
				<Template>
					...
					<px:PXTextEdit ID="edExtRefNbr" runat="server" DataField="ExtRefNbr" TabIndex="251" />
