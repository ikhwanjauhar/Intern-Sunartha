                    ...
                    <px:PXGrid ID="ProductsGrid" SkinID="Details" runat="server" Width="100%" Height="500px" DataSourceID="ds" ActionsPosition="Top" BorderWidth="0px" SyncPosition="true">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Products">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="InventoryID" DisplayFormat="CCCCCCCCCCCCCCCCCCCC" AutoCallBack="True" />
                                    ...
                                    <px:PXGridColumn DataField="Quantity" TextAlign="Right" AutoCallBack="True" />
                        ...
                        <Levels>
                          <px:PXGridLevel DataMember="SalesOrders">
                            ...
                            <Columns>
                              ...
                              <px:PXGridColumn DataField="CuryID" />
                              <px:PXGridColumn DataField="OrderTotal" />
