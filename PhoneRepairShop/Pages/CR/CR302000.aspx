...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Contact"
			...
			<px:PXTabItem Text="Details" RepaintOnDemand="False">
				<Template>
                    ...
                    <px:PXDropDown ID="Method" runat="server" TabIndex="220" DataField="Method" />
						...
						<px:PXTextEdit ID="edExtRefNbr" runat="server" DataField="ExtRefNbr" TabIndex="201" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Duplicates">
								<Columns>
                                    ...
                                    <px:PXGridColumn DataField="Contact2__ContactType" TextAlign="Left" AllowShowHide="False" />
                                    <px:PXGridColumn DataField="BAccountR__Type" TextAlign="Left" />
                                    <px:PXGridColumn DataField="Contact2__DuplicateStatus" TextAlign="Left" />
									<px:PXGridColumn DataField="Contact2__LastModifiedDateTime" TextAlign="Left" />
									<px:PXGridColumn DataField="Contact2__DisplayName" TextAlign="Left" AllowShowHide="False"  LinkCommand="Duplicates_Contact_ViewDetails" />									
									<px:PXGridColumn DataField="Contact2__BAccountID" TextAlign="Left" LinkCommand="Duplicates_BAccount_ViewDetails"  />
                                    <px:PXGridColumn DataField="BAccountR__AcctName" TextAlign="Left" />
									<px:PXGridColumn DataField="Contact2__Email" TextAlign="Left" AllowShowHide="False" />
                                    <px:PXGridColumn DataField="Contact2__ContactID" TextAlign="Left" Visible="false"
						...
						<Levels>
							<px:PXGridLevel DataMember="Subscriptions">
								<Columns>
									...
									<px:PXGridColumn DataField="MarketingListID" AutoCallBack="true" TextField="CRMarketingList__MailListCode"
