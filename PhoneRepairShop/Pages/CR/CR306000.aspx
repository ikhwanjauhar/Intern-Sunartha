                    ...
                    <px:PXGrid ID="gridCaseReferencesDependsOn" runat="server" DataSourceID="ds" Height="162px" Style="z-index: 101; left: 0px; position: absolute; top: 0px;" AllowSearch="True"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CaseRefs">
                                <Columns>
                                    <px:PXGridColumn DataField="ChildCaseID" RenderEditorText="True" AutoCallBack="True" LinkCommand="CaseRefs_CRCase_ViewDetails" />
                                    <px:PXGridColumn DataField="RelationType" RenderEditorText="True" AutoCallBack="true" />
                                    <px:PXGridColumn DataField="CRCaseRelated__Subject" />
                                    <px:PXGridColumn DataField="CRCaseRelated__Status" />
                                    <px:PXGridColumn DataField="CRCaseRelated__OwnerID" DisplayMode="Text" />
                                    <px:PXGridColumn DataField="CRCaseRelated__WorkgroupID" />
                                </Columns>
