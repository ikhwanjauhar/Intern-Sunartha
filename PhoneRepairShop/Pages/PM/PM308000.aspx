		...
		<px:PXGrid runat="server" SyncPosition="true" Height="240px" SkinID="Details" Width="100%" ID="AvailableChangeRequestGrid" DataSourceID="ds">
			...
			<Levels>
				<px:PXGridLevel DataMember="AvailableChangeRequests">
					<Columns>
						<px:PXGridColumn Type="CheckBox" DataField="Selected" Width="63px" AllowCheckAll="true" Label="Selected" />
						<px:PXGridColumn DataField="RefNbr" Width="120px" LinkCommand="ViewChangeRequest" />
						<px:PXGridColumn DataField="Date" Width="80px" />
						<px:PXGridColumn DataField="ExtRefNbr" Width="120px" />
						<px:PXGridColumn DataField="Description" Width="180px" />
						<px:PXGridColumn TextAlign="Right" DataField="CostTotal" Width="81px" />
						<px:PXGridColumn TextAlign="Right" DataField="LineTotal" Width="81px" />
						<px:PXGridColumn TextAlign="Right" DataField="MarkupTotal" Width="81px" />
						<px:PXGridColumn TextAlign="Right" DataField="PriceTotal" Width="81px" /></Columns></px:PXGridLevel></Levels></px:PXGrid>
			...
			<Levels>
				<px:PXGridLevel DataMember="ChangeRequestCostDetails">
					<Columns>
						<px:PXGridColumn DataField="RefNbr" Width="120px" LinkCommand="ViewChangeRequest" />
						<px:PXGridColumn DataField="Description" Width="180px" />
						<px:PXGridColumn TextAlign="Right" DataField="Qty" Width="81px" />
						<px:PXGridColumn TextAlign="Right" DataField="UnitCost" Width="81px" />
						<px:PXGridColumn TextAlign="Right" DataField="ExtCost" Width="81px" /></Columns></px:PXGridLevel></Levels></px:PXGrid></px:PXSmartPanel>
                    ...
                    <Levels>
                        <px:PXGridLevel DataMember="ChangeRequestRevenueDetails">
                            <Columns>
                                ...
                                <px:PXGridColumn DataField="Description" Width="180px" />
                                <px:PXGridColumn TextAlign="Right" DataField="Qty" Width="81px" />
                                <px:PXGridColumn TextAlign="Right" DataField="UnitPrice" Width="81px" />
                                <px:PXGridColumn TextAlign="Right" DataField="ExtPrice" Width="81px" />
                                <px:PXGridColumn TextAlign="Right" DataField="LineAmount" Width="81px" />
                            </Columns>
                        </px:PXGridLevel>
                    </Levels>
                </px:PXGrid>
                    ...
                    <Levels>
                        <px:PXGridLevel DataMember="ChangeRequestMarkupDetails">
                            <Columns>
                                ...
                                <px:PXGridColumn DataField="Description" Width="180px" />
                                <px:PXGridColumn TextAlign="Right" DataField="Value" Width="81px" />
                                <px:PXGridColumn TextAlign="Right" DataField="MarkupAmount" Width="81px" />
                            </Columns>
                        </px:PXGridLevel>
                    </Levels>
                </px:PXGrid>
                    ...
                    <px:PXGrid runat="server" ID="gridChangeRequests" SkinID="DetailsInTab" Width="100%" SyncPosition="True">
                        <Levels>
                            <px:PXGridLevel DataMember="ChangeRequests">
                                <Columns>
                                    <px:PXGridColumn DataField="RefNbr" Width="140" LinkCommand="ViewChangeRequest" />
                                    <px:PXGridColumn DataField="Status" Width="90" />
                                    <px:PXGridColumn DataField="Description" Width="280" />
                                    <px:PXGridColumn DataField="CostTotal" Width="100" />
                                    <px:PXGridColumn DataField="LineTotal" Width="100" />
                                    <px:PXGridColumn DataField="MarkupTotal" Width="100" />
                                    <px:PXGridColumn DataField="PriceTotal" Width="100" />
                                    <px:PXGridColumn DataField="DelayDays" Width="100" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AutoCallBack="True" DataField="AccountGroupID" />
                                    <px:PXGridColumn DataField="Description" />
                                    <px:PXGridColumn DataField="ChangeRequestQty" Width="100" />
                                    <px:PXGridColumn DataField="Qty" TextAlign="Right" CommitChanges="true" />
                                    <px:PXGridColumn DataField="UOM" TextAlign="Right" CommitChanges="true" />
                                    <px:PXGridColumn DataField="Rate" TextAlign="Right" CommitChanges="true" />
                                    <px:PXGridColumn DataField="ChangeRequestAmount" />
