		...
		<Template>
				...
				<Levels>
					<px:PXGridLevel DataMember="ChangeRequests">
						<Columns>
							...
							<px:PXGridColumn DataField="PriceTotal" Width="100" /></Columns></px:PXGridLevel></Levels>
				<AutoSize Enabled="True" MinHeight="150" />
            ...
            <px:PXTabItem Text="Settings">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" ID="CstPXLayoutRule1" StartColumn="True" StartGroup="True" />
