    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="Details" Caption="Transaction Details"
        ...
        <Levels>
            <px:PXGridLevel DataMember="Transactions">
                ...
                <Columns>
                    <px:PXGridColumn DataField="BranchID" Label="Branch" AutoCallBack="True" />
                    <px:PXGridColumn DataField="ProjectID" Label="Project" AutoCallBack="true" LinkCommand="ViewProject" />
                    <px:PXGridColumn DataField="TaskID" Label="Task" LinkCommand="ViewTask" AutoCallBack="True"/>
                    <px:PXGridColumn DataField="CostCodeID" AutoCallBack="true" />
                    <px:PXGridColumn DataField="AccountGroupID" Label="Account Group" AutoCallBack="true" />
                    <px:PXGridColumn DataField="ResourceID" Label="Resource" AutoCallBack="true" />
                    <px:PXGridColumn DataField="BAccountID" Label="Customer/Vendor" AutoCallBack="true" LinkCommand ="ViewCustomer"/>
                    <px:PXGridColumn DataField="LocationID" Label="Location" />
                    <px:PXGridColumn DataField="InventoryID" Label="InventoryID" AutoCallBack="true" LinkCommand="ViewInventory"/>
                    ...
                    <px:PXGridColumn DataField="BillableQty" Label="BillableQty" TextAlign="Right" AutoCallBack="true" />
                    <px:PXGridColumn DataField="TranCuryUnitRate" Label="TranCuryUnitRate" TextAlign="Right" AutoCallBack="true"/>

                    <px:PXGridColumn DataField="TranCuryAmount" Label="TranCuryAmount" TextAlign="Right"  AutoCallBack="true" />
					<px:PXGridColumn DataField="TranCuryId" Label="Currency" AutoCallBack="true" />
					<px:PXGridColumn DataField="BaseCuryRate" Label="Base Currency Rate" TextAlign="Right" />

					<px:PXGridColumn DataField="ProjectCuryAmount" Label="Project Transaction Amount" TextAlign="Right" />
					<px:PXGridColumn DataField="ProjectCuryId" Label="Project Currency" />
					<px:PXGridColumn DataField="ProjectCuryRate" Label="Project Currency Rate" TextAlign="Right" />

					<px:PXGridColumn DataField="StartDate" Visible="false" />
                    <px:PXGridColumn DataField="EndDate" Visible="false" />
                    <px:PXGridColumn DataField="AccountID" Label="Account" AutoCallBack="true" />
                    <px:PXGridColumn DataField="SubID" Label="Subaccount" />
                    <px:PXGridColumn DataField="OffsetAccountID" Label="Offset Account" AutoCallBack="true" />
                    ...
                    <px:PXGridColumn DataField="UseBillableQty" Label="UseBillableQty" TextAlign="Center" Type="CheckBox"  />
