...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="EarningTypes" TabIndex="2100">
		<Template>
            ...
            <px:PXCheckBox runat="server" DataField="IsAmountBased" ID="edIsAmountBased" CommitChanges="True" />
            <px:PXCheckBox runat="server" DataField="IsPiecework" ID="edIsPiecework" CommitChanges="True" />
			<px:PXCheckBox runat="server" DataField="isOverTime" ID="edOvertime" CommitChanges="True" />
            ...
            <px:PXCheckBox runat="server" DataField="IsWCCCalculation" ID="edIsWCCCalculation" />
			<px:PXSelector ID="edWageTypeCD" runat="server" DataField="WageTypeCD" AutoRefresh="True" />
