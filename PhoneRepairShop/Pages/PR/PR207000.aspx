		...
		<Items>
			<px:PXTabItem Text="Employee Information">
				<Template>
					...
					<px:PXGrid ID="gridEmployees" runat="server" DataSourceID="ds" Width="100%" SkinID="Inquire">
						<Levels>
							<px:PXGridLevel DataMember="FilteredEmployeeInformation">
								<Columns>
									...
									<px:PXGridColumn DataField="EPEmployee__AcctCD" Width="200px" />
			...
			<px:PXTabItem Text="Company Information">
				<Template>
					<px:PXGrid ID="gridCompany" runat="server" DataSourceID="ds" Width="100%" SkinID="Inquire">
						<Levels>
