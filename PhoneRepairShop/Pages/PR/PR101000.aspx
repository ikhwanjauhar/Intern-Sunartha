		...
		<Items>
			<px:PXTabItem Text="General Info">
				<Template>
                    ...
                    <px:PXCheckBox ID="edSummarizeTimeCard" runat="server" DataField="SummarizeTimeCard" Text="Summarize Time Card" />
                    <px:PXSelector ID="edCommissionType" runat="server" DataField="CommissionType" />
                    <px:PXSelector ID="edLeaveType" runat="server" DataField="LeaveType" />
					...
					<px:PXDropDown ID="edEarningsAcctDefault" runat="server" AllowNull="False" DataField="EarningsAcctDefault" />
					<px:PXSegmentMask ID="edEarningsSubMask" runat="server" DataField="EarningsSubMask" />
					...
					<px:PXDropDown ID="edBenefitExpenseAcctDefault" runat="server" AllowNull="False" DataField="BenefitExpenseAcctDefault" />
					<px:PXSegmentMask ID="edBenefitExpenseSubMask" runat="server" DataField="BenefitExpenseSubMask" />
					...
					<px:PXDropDown ID="edTaxExpenseAcctDefault" runat="server" AllowNull="False" DataField="TaxExpenseAcctDefault" />
					<px:PXSegmentMask ID="edTaxExpenseSubMask" runat="server" DataField="TaxExpenseSubMask" />
