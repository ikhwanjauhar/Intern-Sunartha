<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="PR209800.aspx.cs"
    Inherits="Page_PR209800" Title="Workers' Compensation Code" %>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phG" runat="Server">
	<px:PXSplitContainer ID="splitContainerWorkCodes" runat="server" PositionInPercent="true" SplitterPosition="50" Orientation="Vertical" Height="100%">
		<Template1>
			<px:PXGrid ID="grid1" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" AllowSearch="true"
				AdjustPageSize="Auto" DataSourceID="ds" SkinID="Details" SyncPosition="true" FastFilterFields="Description" CaptionVisible="true" Caption="WC Code" KeepPosition="true">
				<Levels>
				...
				<Levels>
					<px:PXGridLevel DataMember="WorkCompensationRates">
						<Columns>
							...
							<px:PXGridColumn DataField="DeductCodeID" Width="150px" CommitChanges="true" />
