...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" DataMember="CurrentDocument">
		<Items>
			...
			<px:PXTabItem Text="Taxes">
				<Template>
					<px:PXGrid ID="grdTaxes" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" Height="500px">
						<Levels>
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton DependOnGrid="grid" CommandSourceID="ds">
									<AutoCallBack Command="ViewTaxSplits" Target="ds" />
								</px:PXToolBarButton>
								<px:PXToolBarButton DependOnGrid="grid" CommandSourceID="ds">
						...
						<Levels>
							<px:PXGridLevel DataMember="WCPremiums">
								<Columns>
									...
									<px:PXGridColumn DataField="DeductCodeID" Width="200px" CommitChanges="true" />
	...
	<px:PXSmartPanel runat="server" ID="spDeductionDetails" AutoRepaint="true" Caption="Deduction Details" CaptionVisible="true" Key="DeductionDetails">
			...
			<Levels>
				<px:PXGridLevel DataMember="DeductionDetails">
					<Columns>
						...
						<px:PXGridColumn DataField="SubID" Width="100px" CommitChanges="True" />
						<px:PXGridColumn DataField="ProjectID" Width ="150px" />
						<px:PXGridColumn DataField="UnionID" Width="70px" />
					</Columns>
				</px:PXGridLevel>
			</Levels>
			<AutoSize Enabled="true" MinHeight="150" />
	...
	<px:PXSmartPanel runat="server" ID="spBenefitDetails" AutoRepaint="true" Caption="Benefit Details" CaptionVisible="true" Key="BenefitDetails" Width="300px">
		<px:PXGrid ID="BenefitDetailsGrid" runat="server" DataSourceID="ds" SkinID="Inquire">
			<Levels>
				<px:PXGridLevel DataMember="BenefitDetails">
					<Columns>
						<px:PXGridColumn DataField="BranchID" />
						<px:PXGridColumn DataField="CodeID" Width="100px" />
						...
						<px:PXGridColumn DataField="UnionID" Width="70px" />
						<px:PXGridColumn DataField="WorkCodeID" Width="70px" />
					</Columns>
				</px:PXGridLevel>
			</Levels>
			<AutoSize Enabled="true" MinHeight="150" />
	...
	<px:PXSmartPanel runat="server" ID="spTaxDetails" AutoRepaint="true" Caption="Tax Details" CaptionVisible="true" Key="TaxDetails" Width="300px">
		<px:PXGrid ID="TaxDetailsGrid" runat="server" DataSourceID="ds" SkinID="Inquire">
			<Levels>
