...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Employee" TypeName="PX.Objects.PR.PREmployeePayrollSettingsMaint">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Employee">
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
			<px:PXSegmentMask ID="edAcctCD" runat="server" DataField="AcctCD" DataSourceID="ds" FilterByAllFields="True" DisplayMode="Value" AllowEdit="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CurrentEmployee">
		<Items>
			<px:PXTabItem Text="General Info">
				<Template>
					...
					<px:PXDropDown ID="edEmpType" runat="server" TabIndex="25" DataField="EmpType" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkEmpTypeUseDflt" runat="server" TabIndex="30" DataField="EmpTypeUseDflt" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXSelector ID="edPayGroupID" runat="server" TabIndex="35" DataField="PayGroupID" AllowEdit="True" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkPayGroupUseDflt" runat="server" DataField="PayGroupUseDflt" TabIndex="40" CommitChanges="True" />

                    <px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXTextEdit ID="edCalendarID" runat="server" DataField="CalendarID" TabIndex="45" Width="200" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="edCalendarIDUseDflt" runat="server" DataField="CalendarIDUseDflt" TabIndex="47" CommitChanges="True" />
					...
					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkStdWeeksPerYearUseDflt" runat="server" DataField="StdWeeksPerYearUseDflt" TabIndex="57" CommitChanges="True" />
					
					<px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXNumberEdit ID="edHoursPerYear" runat="server" DataField="HoursPerYear" TabIndex="60" Width="200" />

                    <px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkExemptFromOvertimeRules" runat="server" DataField="ExemptFromOvertimeRules" TabIndex="62" Width="200" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkExemptFromOvertimeRulesUseDflt" runat="server" DataField="ExemptFromOvertimeRulesUseDflt" TabIndex="63" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXNumberEdit ID="edNetPayMin" runat="server" AllowNull="True" DataField="NetPayMin" TabIndex="65" Width="200" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkNetPayMinUseDflt" runat="server" DataField="NetPayMinUseDflt" TabIndex="70" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXSelector ID="edLocationID" runat="server" DataField="LocationID" TabIndex="75" AllowEdit="True" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkLocationUseDflt" runat="server" TabIndex="80" DataField="LocationUseDflt" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXSelector ID="edUnionID" runat="server" TabIndex="95" DataField="UnionID" AllowEdit="True" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkUnionUseDflt" runat="server" TabIndex="100" DataField="UnionUseDflt" CommitChanges="True" />

					<px:PXLayoutRule runat="server" StartRow="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXSelector ID="edWorkCodeID" runat="server" TabIndex="105" DataField="WorkCodeID" AllowEdit="True" />

					<px:PXLayoutRule runat="server" StartColumn="true" ControlSize="M" LabelsWidth="SM" />
					<px:PXCheckBox ID="chkWorkCodeUseDflt" runat="server" TabIndex="110" DataField="WorkCodeUseDflt" CommitChanges="True" />

					<px:PXLayoutRule runat="server" EndGroup="true" />

					<px:PXLayoutRule runat="server" GroupCaption="Tax Location Info" LabelsWidth="SM" ControlSize="M" StartRow="True" />
					<px:PXFormView ID="PXFormView2" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Address" TabIndex="9100" RenderStyle="Simple">
						<Template>
							...
							<px:PXButton runat="server" TabIndex="100" ID="btnGetTaxEngineCodes" CommandName="GetTaxCodes" CommandSourceID="ds" Text="Get Tax Engine Codes" />
			...
			<px:PXTabItem Text="Earnings">
				<Template>
					<px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" SkinID="DetailsInTab" Width="100%" MatrixMode="True">
						<Levels>
			...
			<px:PXTabItem Text="Deductions and Benefits" LoadOnDemand="true" RepaintOnDemand="true">
				<Template>
					<px:PXFormView ID="splitTypeForm" runat="server" DataMember="CurrentEmployee">
						<Template>
					...
					<px:PXGrid ID="gridDeductions" runat="server" DataSourceID="ds" SkinID="DetailsInTab" Height="200px" Width="100%" SyncPosition="True">
						<Levels>
							<px:PXGridLevel DataMember="EmployeeDeduction">
								<RowTemplate>
									<px:PXSelector ID="edEmployeeDeduction" runat="server" DataField="CodeID" AllowEdit="true" />
								</RowTemplate>
								<Columns>
			...
			<px:PXTabItem Text="Taxes">
				<Template>
					<px:PXSplitContainer runat="server" ID="sp2" SplitterPosition="300" SkinID="Horizontal" Height="730px">
						<AutoSize Enabled="true" />
						<Template1>
						...
						<Template2>
							<px:PXGrid ID="EmployeeTaxAttributes" runat="server" DataSourceID="ds" Caption="Tax Attributes" CaptionVisible="true" MatrixMode="True" SkinID="Inquire" Width="100%">
								<Levels>
			...
			<px:PXTabItem Text="Payment Settings">
				<Template>
					<px:PXFormView ID="formPaymentSettings" runat="server" Width="100%" DataMember="CurrentEmployee" DataSourceID="ds" SkinID="Transparent">
						<Template>
							<px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="SM" StartColumn="True" />
				...
				<Template>
					<px:PXFormView ID="fPTOBanksFilter" runat="server" DataMember="PTOBanksFilter">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartRow="true" ControlSize="S" LabelsWidth="S" />
							<px:PXCheckBox ID="edUsePTOBanksFromClass" runat="server" DataField="CurrentEmployee.UsePTOBanksFromClass" CommitChanges="True" />
						</Template>
					</px:PXFormView>
			...
			<px:PXTabItem Text="GL Accounts">
				<Template>
					<px:PXFormView ID="frmGLAccounts" runat="server" DataMember="CurrentEmployee" Width="100%" CaptionVisible="False" TemplateContainer="" DataSourceID="ds" SkinID="Transparent">
						<Template>
