				...
				<Template>
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="ReceivePutAwaySetup" DefaultControlID="edShowReceivingTab" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox SuppressLabel="True" ID="edShowReceivingTab" runat="server" DataField="ShowReceivingTab" CommitChanges="true" />
							<px:PXCheckBox SuppressLabel="True" ID="edShowPutAwayTab" runat="server" DataField="ShowPutAwayTab" CommitChanges="true" />
							...
							<px:PXCheckBox SuppressLabel="True" ID="edUseCartsForPutAway" runat="server" DataField="UseCartsForPutAway" />

							<px:PXCheckBox SuppressLabel="True" ID="edDefaultLotSerialNumber" runat="server" DataField="DefaultLotSerialNumber" CommitChanges="true" />
							<px:PXCheckBox SuppressLabel="True" ID="edDefaultExpireDate" runat="server" DataField="DefaultExpireDate" CommitChanges="true" />
							<px:PXCheckBox SuppressLabel="True" ID="edSingleLocation" runat="server" DataField="SingleLocation" CommitChanges="true" />
							<px:PXCheckBox SuppressLabel="True" ID="edDefaultReceivingLocation" runat="server" DataField="DefaultReceivingLocation" CommitChanges="true" />

							<px:PXCheckBox SuppressLabel="True" ID="edRequestLocationForEachItemInReceive" runat="server" DataField="RequestLocationForEachItemInReceive" />
							<px:PXCheckBox SuppressLabel="True" ID="edRequestLocationForEachItemInPutAway" runat="server" DataField="RequestLocationForEachItemInPutAway" />
							...
							<px:PXCheckBox SuppressLabel="True" ID="edPrintPurchaseReceiptAutomatically" runat="server" DataField="PrintPurchaseReceiptAutomatically" CommitChanges="true" />
						</Template>
					</px:PXFormView>
				</Template>
			</px:PXTabItem>
