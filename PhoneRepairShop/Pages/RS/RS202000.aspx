...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form"
        ...
        <Template>
            ...
            <px:PXTextEdit ID="Description" runat="server" DataField="Description" DefaultLocale="">
            </px:PXTextEdit>
            ...
            <px:PXDropDown ID="AvgComplexityOfRepair" runat="server" DataField="AvgComplexityOfRepair">
            </px:PXDropDown>
