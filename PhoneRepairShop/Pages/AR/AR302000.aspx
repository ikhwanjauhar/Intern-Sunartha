...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
                    ...
                    <px:PXGrid ID="detgrid" runat="server" Style="z-index: 100;" Width="100%" Height="300px" SkinID="DetailsInTab" 
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Adjustments" >
                                ...
                                <Columns>
									<px:PXGridColumn DataField="Selected" TextAlign="Center" Type="CheckBox" AllowCheckAll="True" AllowSort="True" AllowFilter="True" AllowMove="False" Width="30px" AutoCallBack="True" />
    ...
    <px:PXSmartPanel ID="pnlLoadOpts" runat="server" Style="z-index: 108;" Caption="Load Options" CaptionVisible="True" Key="loadOpts" AutoReload="true" LoadOnDemand="true">
        <px:PXFormView ID="loform" runat="server" Style="z-index: 100;" DataMember="loadOpts" CaptionVisible="False" DefaultControlID="edFromDate" SkinID="Transparent">
            ...
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="180px" ColumnWidth="320" ControlSize="S" />
				<px:PXSegmentMask ID="edOrganizationID" DataField="OrganizationID" DataSourceID="ds" CommitChanges="True" runat="server" Width=""  TabIndex="1"  />
				<px:PXSegmentMask ID="edBranchID" DataField="BranchID" AutoRefresh="true" DataSourceID="ds" CommitChanges="True" runat="server"  TabIndex="2"  />
				<px:PXDateTimeEdit ID="edFromDate" runat="server" DataField="FromDate"  TabIndex="3" />
                ...
                <px:PXNumberEdit ID="edMaxDocs" runat="server" AllowNull="False" DataField="MaxDocs" TabIndex="9" />
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="160px" ColumnWidth="320" ControlSize="S" />
                <px:PXLabel ID="lSpace1" runat="server"></px:PXLabel>
                <px:PXLabel ID="lSpace2" runat="server"></px:PXLabel>
				<px:PXDateTimeEdit ID="edTillDate" runat="server" DataField="TillDate" TabIndex="4" />
                ...
                <px:PXGroupBox RenderStyle="Fieldset" ID="gbOrderBy" runat="server" Caption="Sort Order" DataField="OrderBy" >
                    <Template>
                        ...
                        <px:PXRadioButton ID="rbDueDateRefNbr" runat="server" Text="Due Date, Reference Nbr." Value="DUE" GroupName="gbOrderBy" TabIndex="10" />
                        <px:PXRadioButton ID="rbDocDateRefNbr" runat="server" Text="Doc. Date, Reference Nbr." Value="DOC" GroupName="gbOrderBy" TabIndex="11" />
                        <px:PXRadioButton ID="rbRefNbr" runat="server" Text="Reference Nbr." Value="REF" GroupName="gbOrderBy" TabIndex="12" />
                    </Template>
                </px:PXGroupBox>
                <px:PXGroupBox RenderStyle="Fieldset" ID="gbSOOrderBy" runat="server" Caption="Order By" DataField="SOOrderBy">
                    <Template>
                        ...
                        <px:PXRadioButton ID="rbOrderDateOrderNbr" runat="server" Text="Order Date, Order Nbr." Value="DAT" GroupName="gbSOOrderBy" TabIndex="13" />
                        <px:PXRadioButton ID="rbOrderNbr" runat="server" Text="Order Nbr." Value="ORD" GroupName="gbSOOrderBy"  TabIndex="14" />
                    </Template>
                </px:PXGroupBox>
                <px:PXLayoutRule runat="server" StartColumn="True" SuppressLabel="True" ControlSize="M" LabelsWidth="S" StartRow="False" ColumnWidth="320" />
                <px:PXGroupBox RenderStyle="Fieldset" ID="gbLoadingMode" runat="server" >
                    <Template>
                        <px:PXCheckBox ID="chApply" DataField="Apply" Size="SM" runat="server" Width="100%" TabIndex="15"></px:PXCheckBox>
                    </Template>
                </px:PXGroupBox>
