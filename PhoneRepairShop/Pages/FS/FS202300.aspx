                    ...
                    <px:PXTabItem Text="Preferences">
                        <Template>
                            ...
                            <px:PXGroupBox 
                                ID="gbPostTo" 
                                runat="server" 
                                Caption="Generated Billing Documents" 
                                DataField="PostTo" 
                                CommitChanges="True">
                                <Template>
                                    <px:PXLayoutRule runat="server" StartColumn="True" ControlSize="XM" LabelsWidth="M">
                                    </px:PXLayoutRule>
                                    <px:PXRadioButton ID="gbPostTo_op0" runat="server" GroupName="gbPostTo" Text="AR Documents" Value="AR" />
                                    <px:PXRadioButton ID="gbPostTo_op1" runat="server" GroupName="gbPostTo" Text="Sales Orders" Value="SO" />
                                    <px:PXRadioButton ID="gbPostTo_op2" runat="server" GroupName="gbPostTo" Text="SO Invoices" Value="SI" />
