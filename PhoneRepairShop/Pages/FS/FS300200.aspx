...
<%-- ACTUAL FIELDS --%>
                                    <px:PXGridColumn DataField="KeepActualDateTimes" TextAlign="Center" Type="CheckBox">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ActualDateTimeBegin_Time" CommitChanges="True" NullText="<SPLIT>">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ActualDateTimeEnd_Time" CommitChanges="True" NullText="<SPLIT>">
                                    </px:PXGridColumn>
...
<%-- BILLABLE FIELDS --%>                                    
                                    ...
                                    <px:PXGridColumn DataField="FSSODet__EnablePO" TextAlign="Center" Type="CheckBox" Visible="False">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="FSSODet__POCompleted" TextAlign="Center" Type="CheckBox" Visible="False">
                                    </px:PXGridColumn>
...
<%-- BILLABLE FIELDS --%>
                                    ...
                                    <px:PXNumberEdit ID="edDiscPct2" runat="server" DataField="DiscPct" CommitChanges="True"/>
                                    <px:PXNumberEdit ID="edCuryDiscAmt2" runat="server" DataField="CuryDiscAmt" CommitChanges="True"/>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="SrvOrdType" />
                                    <px:PXGridColumn DataField="BranchID" RenderEditorText="True" AllowShowHide="Server" CommitChanges="True" />
...
<%-- ACTUAL FIELDS --%>
                                    <px:PXGridColumn DataField="Qty" TextAlign="Right" CommitChanges="True" AllowDragDrop="True">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryTranAmt" TextAlign="Right">
                                    </px:PXGridColumn>
<%-- BILLABLE FIELDS --%>
                        ...
                        <Levels>
                            <px:PXGridLevel
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edDiscPct3" runat="server" DataField="DiscPct" CommitChanges="True"/>
                                    <px:PXNumberEdit ID="edCuryDiscAmt3" runat="server" DataField="CuryDiscAmt" CommitChanges="True"/>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="BranchID" RenderEditorText="True" AllowShowHide="Server" CommitChanges="True" />
