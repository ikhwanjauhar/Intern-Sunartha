                    ...
                    <px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Style="z-index: 100" 
                        ...
                        <px:PXGridLevel 
                            ...
                            <RowTemplate>
                                ...
                                <px:PXSelector ID="edServProjectTaskID" runat="server" DataField="ProjectTaskID" AutoRefresh="True" CommitChanges="True">
                                </px:PXSelector>
                                <px:PXSelector ID="edServCostCodeID" runat="server" DataField="CostCodeID" AutoRefresh="true" />
                            </RowTemplate>
                            <Columns>
                        ...
                        <Mode AllowFormEdit="True" AllowUpload="True" AllowDragRows="True"/>
                    ...
                    <px:PXGrid ID="PXGrid2" runat="server" DataSourceID="ds" Style="z-index: 100" 
                        ...
                        <px:PXGridLevel 
                            ...
                            <RowTemplate>
                                ...
                                <px:PXSelector ID="edInvProjectTaskID" runat="server" DataField="ProjectTaskID" AutoRefresh="True" CommitChanges="True">
                                </px:PXSelector>
                                <px:PXSelector ID="edInvCostCodeID" runat="server" DataField="CostCodeID" AutoRefresh="true" />
                            </RowTemplate>
                            <Columns>
                                <px:PXGridColumn DataField="SortOrder" TextAlign="Right">
                                </px:PXGridColumn>
