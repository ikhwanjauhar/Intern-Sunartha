...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ServiceOrderRecords" TypeName="PX.Objects.FS.ServiceOrderEntry">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ServicePasteLine" Visible="False" CommitChanges="True" DependOnGrid="PXGridServices" />
            <px:PXDSCallbackCommand Name="PartPasteLine" Visible="False" CommitChanges="True" DependOnGrid="PXGridParts" />
            <px:PXDSCallbackCommand Name="ServiceResetOrder" Visible="False" CommitChanges="True" DependOnGrid="PXGridServices" />
            <px:PXDSCallbackCommand Name="PartResetOrder" Visible="False" CommitChanges="True" DependOnGrid="PXGridParts" />
            ...
            <px:PXTabItem Text="Services">
                <Template>
                    <px:PXGrid ID="PXGridServices" runat="server" DataSourceID="ds" TabIndex="-12436" SkinID="Details"
                        Width="100%" Height="100%" SyncPosition="True" AllowPaging="true" AdjustPageSize="Auto">
                        <Levels>
                            ...
                            <RowTemplate>
                                <px:PXLayoutRule runat="server" StartColumn="True">
                                    ...
                                    <px:PXSegmentMask ID="edSiteLocationIDServices" runat="server" DataField="SiteLocationID" AutoRefresh="True" CommitChanges="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="PXGridServices" Name="FSSODetService.siteID" PropertyName="DataValues[&quot;SiteID&quot;]" Type="String" />
                                        </Parameters>
                                    </px:PXSegmentMask>
...
<%-- BILLABLE FIELDS --%>
                                    ...
                                    <px:PXNumberEdit ID="edCuryBillableExtPrice" runat="server" DataField="CuryBillableExtPrice">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edDiscPct" runat="server" DataField="DiscPct" CommitChanges="True"/>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Scheduled" TextAlign="Center" Type="CheckBox">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status" CommitChanges="True">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn CommitChanges="True" DataField="LineType">
                                    </px:PXGridColumn>
...
<%-- ESTIMATED FIELDS --%>                                    
                                    ...
                                    <px:PXGridColumn DataField="CuryUnitCost" TextAlign="Right" CommitChanges="True" Visible="false">
                                    </px:PXGridColumn>
...
<%-- APPOINTMENT SUM FIELDS --%>
                                    ...
                                    <px:PXGridColumn DataField="ApptNumber">
                                    </px:PXGridColumn>
...
<%-- BILLABLE FIELDS --%>
                                    ...
                                    <px:PXGridColumn DataField="EnablePO" TextAlign="Center" Type="CheckBox" CommitChanges="True" Visible="false">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="POVendorID" CommitChanges="true" Visible="false">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="POVendorLocationID" Visible="false">
                                    </px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="POCompleted" TextAlign="Center" Type="CheckBox" Visible="false">
                                    </px:PXGridColumn>
                         ...
                         <CallbackCommands PasteCommand="ServicePasteLine">
...
<%-- BILLABLE FIELDS --%>
                                    ...
                                    <px:PXNumberEdit ID="edCuryBillableExtPrice2" runat="server" DataField="CuryBillableExtPrice">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edDiscPct2" runat="server" DataField="DiscPct" />
                                    <px:PXNumberEdit ID="edCuryDiscAmt2" runat="server" DataField="CuryDiscAmt" />
...
<%-- PURCHASE ORDER FIELDS --%>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="SuspendedTargetEquipmentID" TextAlign="Right">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="Warranty" TextAlign="Center" Type="CheckBox">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="IsPrepaid" TextAlign="Center" Type="CheckBox">
...
<%-- ESTIMATED FIELDS --%>                                    
                                    <px:PXGridColumn DataField="EstimatedQty" TextAlign="Right" CommitChanges="True">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryUnitCost" TextAlign="Right" CommitChanges="True" Visible="false">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ManualPrice" TextAlign="Center" Type="CheckBox" CommitChanges="True">
...
<%-- APPOINTMENT SUM FIELDS --%>
                                    <px:PXGridColumn DataField="ApptQty" TextAlign="Right">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryApptTranAmt" TextAlign="Right">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="ApptNumber" TextAlign="Right">
                                    </px:PXGridColumn>
...
<%-- PURCHASE ORDER FIELDS --%>
                         ...
                         <CallbackCommands PasteCommand="PartPasteLine">
                            <Save PostData="Container" />
                        </CallbackCommands>
                        <Mode AllowFormEdit="True" InitNewRow="True" AllowUpload="True" AllowDragRows="True" />
                        <AutoSize Enabled="True" />
            ...
            <Levels>
                <px:PXGridLevel DataKeyNames="SrvOrdType,RefNbr,LineNbr,SplitLineNbr" DataMember="partSplits">
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="RefNoteID" RenderEditorText="True" LinkCommand="FSSODetPartSplit$RefNoteID$Link" />
